            ...
            <div className="section-container">
                ...
                <div className="offers-items">
                    ...
                    <div className="columns is-multiline">
                        ...
                        {offersData.map((offer, index) => (<OfferItem key={index} OfferPoster={offer.poster} offerTitle={i18n.language === 'fr' ? offer.titleFr : i18n.language === 'ar' ? offer.titleAr : offer.titleEn} OfferLink={offer.link} />))}
                ...
                <figure className="portfolio-draw-image image">
                    <img src={OffersSectionImage} alt="reviews about Mohamed Ait Eljaouadi Services" />
                </figure>
