...
import cert_coding from "../assets/images/certifactes/cert_coding_alex.jpg";
import cert_seo from "../assets/images/certifactes/cert_seo_alex.jpg";
import cert_web from "../assets/images/certifactes/cert_web_alex.jpg";
      ...
      <div className="section-container">
        <div className="skills-container">
          ...
          <div className="cert">
            ...
            <div className="columns is-multiline">
              <Ceraficate
                certImage={cert_coding}
                certTitle={"Codinggeek Certification"}
              />
              <Ceraficate
                certImage={cert_seo}
                certTitle={"Udacity 1 Million MAC front end developer"}
              />
              <Ceraficate
                certImage={cert_web}
                certTitle={"Udacity 1 Million MAC front end developer"}
